...
pa::Problem load_CasADi_problem(const std::string &filename, unsigned n = 0,
...
/// `hess_L_prod` should be provided to evaluate the Hessian of the Lagrangian
/// and Hessian-vector products.
pa::ProblemFull load_CasADi_problem_full(const std::string &filename, unsigned n = 0,
                                     unsigned m1 = 0, unsigned m2 = 0,
                                     bool second_order = false);
/// Load a problem generated by CasADi (with parameters).
///
/// @copydetails load_CasADi_problem_full
pa::ProblemFullWithParam load_CasADi_problem_full_with_param(const std::string &filename,
                                     unsigned n = 0, unsigned m1 = 0, unsigned m2 = 0,
                                     unsigned p        = 0,
                                     bool second_order = false);
